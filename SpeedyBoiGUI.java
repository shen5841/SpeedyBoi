...
/**
 * This class provides a GUI for solitaire games related to SpeedyBoi.
 */
public class SpeedyBoiGUI extends JFrame implements ActionListener {
     ...
     */
    public SpeedyBoiGUI(SpeedyBoiBoard gameBoard) {
        board = gameBoard;
        totalWins = 0;
        totalGames = 0;
        ...
        repaint();
        /*
        if (Helper.timeRemain > 0) {
            timerMsg.setText("Time left: " + Helper.timeRemain);
    ...
    public void repaint() {
       ...
       /*
        ...
        /*
         timerMsg = new JLabel("time remain: " + Helper.timeRemain + "s");
        panel.add(timerMsg);
        timerMsg.setBounds(LABEL_LEFT, LABEL_TOP - 30, 250, 30);
        
        bestTimeMsg = new JLabel("Best Time: " + bestTime);
        panel.add(bestTimeMsg);
        bestTimeMsg.setBounds(LABEL_LEFT, LABEL_TOP, 250, 30);
         */
    ...
    private void initDisplay()  {
        ...
        winMsg.setFont(new Font("SansSerif", Font.BOLD, 14));
        ...
        */
        ...
        lossMsg = new JLabel();
        lossMsg.setBounds(LABEL_LEFT, LABEL_TOP + LABEL_HEIGHT_INC - 50, 200, 30);
        lossMsg.setFont(new Font("SanSerif", Font.BOLD, 14));
        lossMsg.setForeground(Color.RED);
        lossMsg.setText("Bonus");
        panel.add(lossMsg);
    ...
    private void signalWin() {
        ...
        //sets time into variable first to make sure there's no delay
        winTime = Helper.timeRemain;
        /*
        winMsg = new JLabel();
        winMsg.setBounds(LABEL_LEFT, LABEL_TOP + LABEL_HEIGHT_INC, 200, 30);
        winMsg.setFont(new Font("SansSerif", Font.BOLD, 14));
